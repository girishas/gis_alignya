					...
					<div class="d-flex flex-row justify-content-between mb-3 chat-heading-container hidden_0">
						<div class="d-flex flex-row chat-heading">
							<a class="d-flex headingimage" href="javascript:void(0);">
								<?php if($user): ?>
									<?php echo showImage($user->photo, "img-thumbnail border-0 rounded-circle ml-0 mr-4 list-thumbnail align-self-center small", "","",$user->first_name, 'users/profile-photo'); ?>
								...
								<div
									...
									<div class="min-width-zero">
										<a href="javascript:void(0);">
											<p class="list-item-heading mb-1 truncate headingname"><?php if($user): ?>  <?php echo $user->first_name." ".$user->last_name; ?> <?php endif; ?></p>
										</a>
        ...
        <div class="app-menu">
            <ul class="nav nav-tabs card-header-tabs ml-0 mr-0 mb-1" role="tablist">
                <li class="nav-item w-50 text-center">
                    <a class="nav-link active steamerst_link" id="first-tab" href="<?php echo url($route_prefix.'/messages'); ?>"><?php echo getLabels('messages'); ?></a>
                </li>
                <li class="nav-item w-50 text-center">
                    <a class="nav-link steamerst_link" id="second-tab" href="<?php echo url($route_prefix.'/groups'); ?>"><?php echo getLabels('Groups'); ?></a>
                </li>
            </ul>
                        ...
                        <div class="scroll" id="messages_list">
							<?php if(!$data->isEmpty()): ?>
								<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									...
									<div class="d-flex flex-row mb-1 border-bottom pb-3 mb-3 chat_list_users <?php echo (!empty($user->uniq_username) and $val->uniq_username == $user->uniq_username)?'active_chat':''; ?>" data-username="<?php echo $val->uniq_username; ?>" style="cursor:pointer;" onclick="onUserSelected(this);">
										<a class="d-flex" href="javascript:void(0);">
											<?php echo showImage($val->photo, "img-thumbnail border-0 rounded-circle mr-3 list-thumbnail align-self-center xsmall userimage".$val->uniq_username, "","",$val->first_name, 'users/profile-photo'); ?>
										...
										<div class="d-flex flex-grow-1 min-width-zero">
											<div class="pl-0 align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero">
												<div class="min-width-zero">
													<a href="javascript:void(0);">
														<p class=" mb-0 truncate" id="msguname<?php echo $val->uniq_username; ?>"><?php echo $val->first_name." ".$val->last_name; ?></p>
													</a>
											...
											<span class="btn btn-xs btn-dark icon-button" id="countmsg<?php echo $val->uniq_username; ?>" style="margin-left:10px;<?php echo ($val->Totalconversation > 0)?'':'display:none;'; ?>"><?php echo $val->Totalconversation; ?></span>
										</div>
									</div>
                        ...
                        <div class="scroll" id="group_list">
                            ...
                            <?php if(!$my_grps->isEmpty()): ?>
								<?php $__currentLoopData = $my_grps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $my_grp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<div class="d-flex flex-row mb-1 border-bottom pb-3 mb-3 chat_list_users" data-username="<?php echo $my_grp->slug; ?>" style="cursor:pointer;" onclick="onUserSelected(this);">
										<a class="d-flex" href="javascript:void(0);">
											...
											<div class="pl-0 align-self-center d-flex flex-column flex-lg-row justify-content-between min-width-zero">
												<div class="min-width-zero">
													<a href="javascript:void(0);">
													 ...
													 <p class="mb-1 text-muted text-small"><?php echo $my_grp->totalMember; ?> <?php echo $my_grp->totalMember > 1?getLabels('Members'):str_singular(getLabels('Members')); ?></p>
													<?php /* <div class="spinner spinner-side" style="opacity:0;" id="mSpinner{!! $val->uniq_username !!}"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div> */ ?>
												</div>
											</div>
										</div>
