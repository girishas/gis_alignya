...
<?php $__env->startSection('content'); ?>
  <main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1><?php echo getLabels('goal_cycles'); ?></h1>
                    ...
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo getLabels('goal_cycles'); ?></li>
                        </ol>
                    </nav>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <?php echo Form::open(array('url' => array($route_prefix.'/goalcycles'), 'class' =>'steamerstudio_searchform', 'name'=>'Search')); ?>

								<div class="form-body">
									<div class="row">
										<div class="col-lg-3">
											<div class="form-group">
												<?php echo Form::text('goalcycle_name', isset($_POST['goalcycle_name'])?trim($_POST['goalcycle_name']):null, array('class' => 'form-control',  'placeholder'=> getLabels('search_by_cycle'))); ?>
										...
										<div class="col-lg-3">               
											...
											<a class="btn btn-dark mb-1 steamerst_link" href="<?php echo url($route_prefix, 'goalcycles'); ?>"><?php echo getLabels('show_all'); ?></a>
										</div>
									</div>
								</div>
							<?php echo Form::close(); ?>
							...
							<div class="table-responsive">
								<table class="table">
									<thead class="thead-light">
										<tr>
										   <th> <?php echo getLabels('cycle_name'); ?> </th>
										   <th> <?php echo getLabels('no_of_months'); ?> </th>
    ...
    <?php echo $__env->make('Element/department/addgoalcycle', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->make('Element/department/updategoalcycle', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <script type="text/javascript">
    	...
    	function updatetheme(id){
	        ...
	        $.ajax({
	            type:"POST",
	            url: "<?php echo url('single-goalcycle-details'); ?>"+"/"+id,
	            data:'_token='+token,
	            dataType:'JSON',
