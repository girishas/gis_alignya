<?php $__env->startSection('content'); ?>
                        ...
                        <div class="col-md-3 col-lg-4 col-sm-4 col-6 mb-4">
                            <a href="<?php echo url('members'); ?>" class="card">
                                <div class="card-body text-center">
                                    ...
                                    <p class="lead text-center"><?php echo $total_members; ?></p>
                                </div>
                            </a>
                        </div>
                       <div class="col-md-3 col-lg-4 col-sm-4 col-6 mb-4">
                            <a href="<?php echo url('team'); ?>" class="card">
                                <div class="card-body text-center">
                                    ...
                                    <p class="lead text-center"><?php echo $total_teams; ?></p>
                                </div>
                            </a>
                        </div>
                        <div class="col-md-3 col-lg-4 col-sm-4 col-6 mb-4">
                            <a href="<?php echo url('department'); ?>" class="card">
                                <div class="card-body text-center">
                                    ...
                                    <p class="lead text-center"><?php echo $total_departments; ?></p>
                                </div>
                            </a>
                        </div>
                    </div>
                                    ...
                                    <div class="card mb-4"> 
                                        <div class="card-body">  
                                            ...
                                            <p class="mb-3"><?php echo (!empty($company_details))?$company_details->slogan:""; ?></p>

                                            <p class="text-muted text-small mb-2">Address</p>
                                            <p class="mb-3"><?php echo (!empty($company_details))?($company_details->address):""; ?></p>
                                            <p class="text-muted text-small mb-2">Industry</p>
                                            <p class="mb-3"><?php echo (!empty($company_details)) && $company_details->industry_id ?(getIndustryName($company_details->industry_id))->name:""; ?></p>

                                            <p class="text-muted text-small mb-2">Subscription Plan</p>
                                            <p class="mb-3">
                                                <a href="#">
                                                    <span
                                                        class="badge badge-pill badge-outline-theme-2 mb-1"><?php echo $plan_details->heading; ?> / <?php echo config('constants.PLAN_PERIOD.'.$plan_details->period); ?></span>
                                                </a>
                                                
                                            </p>
                                            <p class="text-muted text-small mb-2">Registered Email</p>
                                            <div class="social-icons  mb-3"><?php echo (!empty($company_details))?($company_details->email):""; ?></div>
                                            <p class="text-muted text-small mb-2">Company Licence</p>
                                            <div class="social-icons  mb-3"><?php echo (!empty($company_details))?($company_details->comp_licence):""; ?></div>
                                            <p class="text-muted text-small mb-2">Company Currency</p>
                                            <div class="social-icons  mb-3"><?php echo (!empty($company_details))?($company_details->company_currency):""; ?></div>
                                             <p class="text-muted text-small mb-2">Fiscal Start Month</p>
                                            <div class="social-icons  mb-3"><?php echo (!empty($company_details))?(config('constants.COMPANY_FISCAL_MONTH.'.$company_details->fiscal_start_month)):""; ?></div>
                                            <p class="text-muted text-small mb-2">Contact</p>
                                            <div class="social-icons  mb-3">  <?php echo (!empty($company_details))?($company_details->mobile):""; ?> </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="mb-4">
                                <a href="#">
                                    ...
                                    <p class="mb-6 "><?php echo (!empty($company_details))?($company_details->com_mission):""; ?></p>
                                </a>
                             ...
                             <div class="mb-4">
                                <a href="#">
                                    ...
                                    <p class="mb-6"><?php echo (!empty($company_details))?($company_details->com_vision):""; ?></p>
                                </a>
                                <div class="separator"></div>
                            </div>
                             <div class="mb-4">
                                <a href="#">
                                    ...
                                    <p class="mb-6 "><?php echo (!empty($company_details))?($company_details->com_values):""; ?></p>
                                </a>
                                <div class="separator"></div>
                            </div>
                            <div class="mb-4">
                                <a href="#">
                                    ...
                                    <p class="mb-6 "><?php echo (!empty($company_details))?($company_details->com_competitive_advantages):""; ?></p>
                                </a>
                                <div class="separator"></div>
                            </div>
                             <div class="mb-4">
                                <a href="#">
                                    ...
                                    <p class="mb-6"><?php echo (!empty($company_details))?($company_details->com_focus_area):""; ?></p>
                                </a>
                                <div class="separator"></div>
                            </div>
                             <div class="mb-4">
                                <a href="#">
                                    ...
                                    <p class="mb-6 "><?php echo (!empty($company_details))?($company_details->comp_strategic_issue):""; ?></p>
                                </a>
                                <div class="separator"></div>
                            </div>
	...
	<script type="text/javascript">
		function updateProfile(){
			$.ajax({
				type:"POST",
				url: "<?php echo url('/getprofiledata'); ?>",
