                        ...
                        <div class="form-side">
                           ...
                           <?php echo Form::open(array('url' => url($route_prefix.'/login'), 'class'=>'steamerstudio_formlogin', 'id'=>'login', 'files' => true)); ?>
							...
							<?php if($route_prefix != env('ADMIN_PREFIX')): ?>
								 ...
								 <div class="d-flex flex-row mb-3 mt-3">
									<a class="btn btn-primary" onclick="applogin(this)" rel="<?php echo e(url('auth/mixer')); ?>" href="javascript:void(0);" style=" background-color:#152C5A;border-color:#152C5A;width:100%;"><b>Mixer</b></a>&nbsp;&nbsp;
									<a class="btn btn-primary" onclick="applogin(this)" rel="<?php echo e(url('auth/twitch')); ?>" href="javascript:void(0);" style="background-color:#6441A4;border-color:#6441A4;width:100%;"><b>Twitch</b></a>
