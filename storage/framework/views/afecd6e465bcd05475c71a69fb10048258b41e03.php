...
<?php $__env->startSection('content'); ?>
  <main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1><?php echo getLabels('idea_categories'); ?></h1>
                    ...
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo getLabels('idea_categories'); ?></li>
                        </ol>
                    </nav>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <?php echo Form::open(array('url' => array($route_prefix.'/idea-categories'), 'class' =>'steamerstudio_searchform', 'name'=>'Search')); ?>
								...
								<div class="form-body">
									<div class="row">
										...
										<div class="col-lg-2">
											<div class="form-group">
												<?php echo Form::select('status', array('' => getLabels('all_status')) + config('constants.MASTER_STATUS'), isset($_POST['status'])?$_POST['status']:null, array('class' => 'form-control')); ?>
										...
										<div class="col-lg-3">               
											...
											<a class="btn btn-dark mb-1 steamerst_link" href="<?php echo url($route_prefix, 'idea-categories'); ?>"><?php echo getLabels('show_all'); ?></a>
										</div>
									</div>
								</div>
							<?php echo Form::close(); ?>
							...
							<div class="table-responsive">
								<table class="table">
									<thead class="thead-light">
										<tr>
										   <th> <?php echo getLabels('idea_category'); ?> </th>
										...
										<?php if(!$data->isEmpty()): ?>
											<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<tr class="odd gradeX">
													...
													<td>
														<a href="javascript:void(0);" onclick="updateideacategory(<?php echo $val->id; ?>)"><i class="heading-icon simple-icon-pencil"></i></a>
    ...
    <?php echo $__env->make('Element/department/addideacategory', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->make('Element/department/updatecategory', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <script type="text/javascript">
    	...
    	function updateideacategory(id){
	        ...
	        $.ajax({
	            type:"POST",
	            url: "<?php echo url('single-idea-categories-details'); ?>"+"/"+id,
	            data:'_token='+token,
	            dataType:'JSON',
