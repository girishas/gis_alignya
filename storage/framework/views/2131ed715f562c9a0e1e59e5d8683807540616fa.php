...
<?php $__env->startSection('content'); ?>
  <main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1><?php echo getLabels('Pages'); ?></h1>
					<div class="text-zero top-right-button-container">
						<a href="<?php echo url($route_prefix.'/add-new-page'); ?>" class="steamerst_link btn btn-primary btn-lg top-right-button mr-1"><?php echo getLabels('add_new_page'); ?></a>
                    </div>
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo getLabels('Pages'); ?></li>
                        </ol>
                    </nav>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <?php echo Form::open(array('url' => array($route_prefix.'/pages'), 'class' =>'steamerstudio_searchform', 'name'=>'Search')); ?>

								<div class="form-body">
									<div class="row">
										<div class="col-lg-6">
											<div class="form-group">
												<?php echo Form::text('title', isset($_POST['title'])?trim($_POST['title']):null, array('class' => 'form-control',  'placeholder'=> getLabels('search_by_title'))); ?>
										...
										<div class="col-lg-3">               
											...
											<a class="btn btn-dark mb-1 steamerst_link" href="<?php echo url($route_prefix, 'pages'); ?>"><?php echo getLabels('show_all'); ?></a>
										</div>
									</div>
								</div>
							<?php echo Form::close(); ?>
							...
							<div class="table-responsive">
								<table class="table">
									<thead class="thead-light">
										<tr>
										   <th> <?php echo SortableTrait::link_to_sorting_action('title_en', getLabels('Title')); ?> </th>
											...
											<th> <?php echo SortableTrait::link_to_sorting_action('updated_at', getLabels('last_updated')); ?> </th>
											...
											<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<tr class="odd gradeX"><?php
													...
													<td class="text-center">
														<?php if($val->status == 1): ?>
															<a class="steamerst_status" href="<?php echo url($route_prefix.'/page-status/'.$val->id); ?>" title="<?php echo getLabels('decline'); ?>"><span class="badge badge-pill badge-secondary "> <?php echo getLabels('approved'); ?> </span></a>
														<?php else: ?>
															<a class="steamerst_status" href="<?php echo url($route_prefix.'/page-status/'.$val->id); ?>" title="<?php echo getLabels('approve'); ?>"><span class="badge badge-pill badge-danger "> <?php echo getLabels('declined'); ?> </span></a>
														<?php endif; ?>
													</td>
													<td> <?php
													...
													<td>
														<div class="btn-group float-none-xs">
															...
															<div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 25px, 0px);">
																<a class="steamerst_link dropdown-item" href="<?php echo url($route_prefix.'/update-page/'.$val->slug); ?>"><?php echo getLabels('edit'); ?></a>
