...
<?php $__env->startSection('content'); ?>
  <main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1><?php echo getLabels('scorecards'); ?></h1>
                     <div class="float-md-right">
                     		<button type="button" class="btn btn-outline-primary mb-1" onclick="addScorecard()">Add Scorecards</button>
                        </div>
                    ...
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo getLabels('scorecards'); ?></li>
                        </ol>
                    </nav>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <?php echo Form::open(array('url' => array($route_prefix.'/scorecards'), 'class' =>'steamerstudio_searchform', 'name'=>'Search')); ?>
								...
								<div class="form-body">
									<div class="row">
										...
										<div class="col-lg-3">               
											...
											<a class="btn btn-dark mb-1 steamerst_link" href="<?php echo url($route_prefix, 'scorecards'); ?>"><?php echo getLabels('show_all'); ?></a>
										</div>
									</div>
								</div>
							<?php echo Form::close(); ?>
							...
							<div class="table-responsive">
								<table class="table">
									<thead class="thead-light">
										<tr>
										   <th> <?php echo getLabels('scorecard_name'); ?> </th>
    ...
    <?php echo $__env->make('Element/department/addscorecard', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->make('Element/department/updatescorecard', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
