        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    ...
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo getLabels('Add Company'); ?></li>
                        </ol>
                    </nav>
           ...
           <div class="card mb-4">
				<div class="card-body">
					...
					<?php echo Form::open(array('url' => array($route_prefix.'/company/add'), 'class' =>'steamerstudio_form needs-validation tooltip-label-right', 'name'=>'Search', 'files'=>true)); ?>
						...
						<div class="form-row">
							...
							<div class="form-group  position-relative error-l-100 col-md-6">
                                <label class=""><?php echo getLabels('password'); ?></label>
