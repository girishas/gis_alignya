		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12 col-sm-6">
					<p class="mb-0 text-muted"><?php echo config('constants.COPYRIGHT_MESSAGE'); ?></p>
				</div>
...
<?php if(Auth::check()): ?>
	<div class="modal fade modal-right" id="changePasswordModal" tabindex="-1" role="dialog" aria-labelledby="changePasswordModal" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<?php echo Form::open(array('url' => array($route_prefix.'/change-password'), 'class' =>'steamerstudio_form needs-validation tooltip-label-right', 'name'=>'Search')); ?>
	...
	<div class="modal fade bd-example-modal-lg" id="postLiveModal" tabindex="-1" role="dialog" aria-modal="true">
		<div class="modal-dialog modal-lg">
			<?php echo Form::open(array('url' => array($route_prefix.'/'.Auth::User()->uniq_username), 'class' =>'steamerstudio_form needs-validation tooltip-label-right', 'files' => true, 'id'=>'post_form', 'name'=>'Search')); ?>
				...
				<div class="modal-content">
					...
					<div class="modal-body bg_input">
						...
						<label class="form-group has-float-label mb-4">
							...
							<div class="invalid-tooltip"></div>
							<span><?php echo getLabels('Title'); ?></span>
						</label>
						
						 <label class="form-group has-float-label mb-4">
							<?php echo Form::textarea('description', null, array("class" => "summernote form-control" )); ?>
						...
						<div class="form-row">
							...
							<label class="form-group has-float-label mb-4 position-relative error-l-40 col-md-6">
								<?php echo Form::select('who_can_see', ['1'=>'public', '2' => 'Followers', '3'=>'Only Me'], null, array('class' => 'input-lg form-control')); ?>
