			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-8">
					<div class="caption">
						...
						<h4><?php echo getLabels('see_whats_next'); ?></h4>
						<h1><?php echo getLabels('watch_Football_other_Live_Sports'); ?></h1>
						<h5><?php echo getLabels('stream_the_top_sportsnetworks_and_live_games'); ?></h5>
						<div class="caption-btn">
							<a class="bg" href="javascript:void(0);"><?php echo getLabels('start_your_free_trial'); ?></a><a href="javascript:void(0);"><?php echo getLabels('read_more'); ?></a>
						</div>
					</div>
				</div>
				<!--end caption-->
			...
			<div class="core-features row">
				...
				<div class="col-lg-3 col-md-4">
					<div class="core-feat-single text-center">
						<div class="icon">
							...
							<?php echo HTML::image("public/upload/page_images/".$aa, "", array("class"=>"img-fluid")); ?>

						</div>
						<h6><?php echo getLabels('no_commitments_cancel_online_at_anytime'); ?></h6>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-4">
					<div class="core-feat-single text-center">
						...
						<h6><?php echo getLabels('Watch_anywhere_on_your_own_time'); ?></h6>
					</div>
				</div>
				<!--end core feature single-->
				<!--start core feature single-->
				<div class="col-lg-3 col-md-4">
					<div class="core-feat-single text-center">
						...
						<h6><?php echo getLabels('Pick_your_price_watch_everything'); ?></h6>
					</div>
				</div>
				<!--end core feature single-->
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="offset-md-6 col-md-6">
					<div class="strm-cont">
						<h4><?php echo getLabels('Top_networks_for_sports'); ?></h4>
						<h2><?php echo getLabels('Your_Live_Sports_Streaming_Platform'); ?></h2>
						<h5><?php echo getLabels('catch_live_and_on_demand_channels'); ?></h5>
					</div>
					<div class="flatfrm-list">
						<ul>
							<li><a href="javascript:void(0);"><?php $aa = pageImage('1-img');?>
							<?php echo HTML::image("public/upload/page_images/".$aa, "", array("class"=>"img-fluid")); ?><br></a></li>
						...
						<h5><a href="javascript:void(0);"><?php echo getLabels('view_channels_in_your_area'); ?> <i class="icofont-long-arrow-right"></i></a></h5>
					</div>
				</div>
			</div>
		</div>
		<div class="strm-flatfrm-img">
			<?php echo HTML::image("public/upload/page_images/". pageImage('flatform-img'), "", array("class"=>"img-fluid")); ?>
			...
			<div class="row">
				...
				<div class="col-md-8 offset-md-2">
					<div class="sec-heading text-center">
						<h4><?php echo getLabels('Some_Fact'); ?></h4>
						<h2 class="counter-title"><?php echo getLabels('Continuous_in_Number'); ?></h2>
						<h5><?php echo getLabels('take_entertainment_with_you'); ?></h5>
					</div>
				</div>
				<!--end section heading-->
			</div>
			<div class="row justify-content-center">
				...
				<div class="col-md-4 col-8">
					<div class="counter-single text-center">
						...
						<h2>80,500</h2>
						<p><?php echo getLabels('TOTAL_MEMBERS'); ?></p>
					</div>
				</div>
				<!--end counter single-->
				<!--start counter single-->
				<div class="col-md-4 col-8">
					<div class="counter-single text-center">
						...
						<h2>50,199</h2>
						<p><?php echo getLabels('VISITORS_ONLINE'); ?></p>
					</div>
				</div>
				<!--end counter single-->
				<!--start counter single-->
				<div class="col-md-4 col-8">
					<div class="counter-single text-center">
						...
						<h2>80,510</h2>
						<p><?php echo getLabels('TOTAL_ACCOUNTS'); ?></p>
					</div>
				</div>
				<!--end counter single-->
			</div>
			...
			<div class="platform-area">
				<div class="container">
					<div class="row">
						...
						<div class="col-md-8 offset-md-2">
							<div class="sec-heading text-center">
								<h4><?php echo getLabels('Explore_Amazing_Features'); ?></h4>
								<h2 class="counter-title"><?php echo getLabels('Seamless_Sports_Streaming_Platform'); ?></h2>
								<h5><?php echo getLabels('build_sports_streaming_platform'); ?></h5>
							</div>
						</div>
						<!--end section heading-->
					</div>
									...
									<div class="swiper-wrapper">
										<div class="swiper-slide">
											<div class="platform-item">
												...
												<h5 class="title"><?php echo getLabels('Instant_Setup'); ?></h5>
												<p><?php echo getLabels('pick_your_favorite_teams'); ?></p>
											</div>
										</div>
										<div class="swiper-slide">
											<div class="platform-item">
												...
												<h5 class="title"><?php echo getLabels('HD_Quality'); ?></h5>
												<p><?php echo getLabels('pick_your_favorite_teams'); ?></p>
											</div>
										</div>
										<div class="swiper-slide">
											<div class="platform-item">
												...
												<?php echo HTML::image("public/upload/page_images/".$aa, "", array("class"=>"img-fluid")); ?> 
												<h5 class="title"><?php echo getLabels('Thousand_Channels'); ?></h5>
												<p><?php echo getLabels('pick_your_favorite_teams'); ?></p>
											</div>
										</div>
										<div class="swiper-slide">
											<div class="platform-item">
												...
												<?php echo HTML::image("public/upload/page_images/".$aa, "", array("class"=>"img-fluid")); ?> 
												<h5 class="title"><?php echo getLabels('Multi_Devices'); ?></h5>
												<p><?php echo getLabels('pick_your_favorite_teams'); ?></p>
											</div>
										</div>
									</div>
			...
			<div class="row">
				...
				<div class="col-md-8 offset-md-2">
					<div class="sec-heading feat text-center">
						<h4><?php echo getLabels('An_Exhaustive_list_of'); ?></h4>
						<h2><?php echo getLabels('Amazing_Features'); ?></h2>
						<h5><?php echo getLabels('watch_the_game_live'); ?></h5>
					</div>
				</div>
				<!--end section heading-->
			</div>
				...
				<div class="row mb-30-none">
					<div class="col-md-6 mb-30">
						<div class="feat-cont left">
							<h5><?php echo getLabels('OUR_BEST_STREAMING_EXPERIENCE'); ?></h5>
							<h3><?php echo getLabels('Get_a_fan_experience_like_no_others'); ?></h3>
							<p><?php echo getLabels('pick_your_favorite_teams'); ?></p>
							<a href="javascript:void(0);" class="cmn-btn"><?php echo getLabels('watch_now'); ?></a>
						</div>
					</div>
				...
				<div class="row mb-30-none">
					...
					<div class="col-md-6 offset-lg-1 mb-30">
						<div class="feat-cont right">
							<h5><?php echo getLabels('LIVE_SPORTS_ON_ANY_SCREEN'); ?></h5>
							<h3><?php echo getLabels('Worldwide_channels_in_your_hand'); ?></h3>
							<p><?php echo getLabels('keep_up_with_live_sports'); ?></p>
							<a href="javascript:void(0);" class="cmn-btn"><?php echo getLabels('try_it_now'); ?></a>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="feat-single">
			<div class="container-fluid">
				<div class="row mb-30-none">
					<div class="col-md-6 mb-30">
						<div class="feat-cont left">
							<h5><?php echo getLabels('PUSH_NOTIFICATIONS'); ?></h5>
							<h3><?php echo getLabels('Find_out_when_its_game_time'); ?></h3>
							<p><?php echo getLabels('get_mobile_push_notifications'); ?></p>
							<a href="javascript:void(0);" class="cmn-btn"><?php echo getLabels('try_it_now'); ?></a>
						</div>
					</div>
					<div class="col-lg-5 offset-lg-1 col-md-6 mb-30">
			...
			<div class="container-fluid">
				<div class="row mb-30-none">
					...
					<div class="col-md-6 offset-md-1 mb-30">
						<div class="feat-cont right">
							<h5><?php echo getLabels('RECORD_&_WATCH'); ?></h5>
							<h3><?php echo getLabels('Watch_everything_on_your_own_time'); ?></h3>
							<p><?php echo getLabels('record_the_sports'); ?></p>
							<a href="javascript:void(0);" class="cmn-btn"><?php echo getLabels('try_it_now'); ?></a>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-lg-7 col-md-8">
						<div class="sec-heading">
							<h4><?php echo getLabels('Meet_Your_New_TV_Experience'); ?></h4>
							<h2 class="text-white"><?php echo getLabels('ALL_YOUR_TV_IN_ONE_PLACE'); ?></h2>
							<h5 class="text-light"><?php echo getLabels('get_full_access_to_the_entire_livesports'); ?></h5>
						</div>
					</div>
					<!--end section heading-->
				</div>
		...
		<div class="container">
			<div class="download-cont-area">
				<div class="row">
					...
					<div class="col-md-6">
						<div class="down-cont">
							<h5><?php echo getLabels('ANYTIME_ANYWHERE'); ?></h5>
							<h3><?php echo getLabels('Stream_you_ hear_ out'); ?></h3>
							<p><?php echo getLabels('get_the_entertainment_you'); ?></p>
							<div class="down-btn">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2">
					<div class="sec-heading text-center">
						<h4><?php echo getLabels('Take_a_look_on'); ?></h4>
						<h2><?php echo getLabels('Latest_Sports_schedule'); ?></h2>
						<h5><?php echo getLabels('view_the_schedule_below'); ?></h5>
					</div>
				</div>
				<!--end section heading-->
			</div>
			...
			<div class="row">
					...
					<div class="chanl-single">
						...
						<div class="chanl-cont-area">
							<div class="chanl-cont">
								<h5 class="m-0"><a href="javascript:void(0);"><?php echo getLabels('BEIN_SPORTS_EN_ESPANOL'); ?></a></h5>
								<p><?php echo getLabels('beIN_SPORTS | Live now'); ?></p>
							</div>
							<div class="chanl-single-logo">
								<a href="javascript:void(0);"><?php $aa = pageImage('1-img');?>
							<?php echo HTML::image("public/upload/page_images/".$aa, "", array("class"=>"img-fluid")); ?></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-6">
					<div class="chanl-single">
						...
						<div class="chanl-cont">
							<h5 class="m-0"><a href="javascript:void(0);"><?php echo getLabels('BEIN_SPORTS'); ?></a></h5>
							<p><?php echo getLabels('beIN_SPORTS_| Live now'); ?></p>
						</div>
						<div class="chanl-single-logo">
				...
				<div class="col-lg-4 col-md-6">
					<div class="chanl-single">
						...
						<div class="chanl-cont">
							<h5 class="m-0"><a href="javascript:void(0);"><?php echo getLabels('NFL_NETWORK'); ?></a></h5>
							<p><?php echo getLabels('Football_|_Live now'); ?></p>
						</div>
						<div class="chanl-single-logo">
				...
				<div class="col-lg-4 col-md-6">
					<div class="chanl-single">
						...
						<div class="chanl-cont">
							<h5 class="m-0"><a href="javascript:void(0);"><?php echo getLabels('MLB_NETWORK'); ?></a></h5>
							<p><?php echo getLabels('MLB_Network | Live now'); ?></p>
						</div>
						<div class="chanl-single-logo">
				...
				<div class="col-lg-4 col-md-6">
					<div class="chanl-single">
						...
						<div class="chanl-cont">
							<h5 class="m-0"><a href="javascript:void(0);"><?php echo getLabels('REAL_SOCIEDAD V ESPANYOL'); ?></a></h5>
							<p><?php echo getLabels('Soccer_|_Watch live at 2:00'); ?></p>
						</div>
						<div class="chanl-single-logo">
				...
				<div class="col-lg-4 col-md-6">
					<div class="chanl-single">
						...
						<div class="chanl-cont">
							<h5 class="m-0"><a href="javascript:void(0);"><?php echo getLabels('MASTERS- DAY_3'); ?></a></h5>
							<p><?php echo getLabels('Snooker_|_Watch live at 19:00'); ?></p>
						</div>
						<div class="chanl-single-logo">
	...
	<section id="faq-area" data-scroll-index="5">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8 offset-md-2">
					<div class="sec-heading text-center">
						<h4><?php echo getLabels('Got_any_Questions?'); ?></h4>
						<h2><?php echo getLabels('We’ve_got_answers!'); ?></h2>
						<h5><?php echo getLabels('were_here_to_help'); ?></h5>
					</div>
				</div>
				<!--end section heading-->
			</div>
				...
				<div class="col-lg-10 offset-lg-1">
					<div id="accordion" role="tablist"><?php
						...
						<?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							...
							<div class="card">
								<div class="card-header" role="tab" id="faq<?php echo $i; ?>">
									<a data-toggle="collapse" href="#collapse<?php echo $i; ?>" aria-expanded="true" aria-controls="collapse<?php echo $i; ?>"><?php echo $faq['question']; ?></a>
								</div>
								<div id="collapse<?php echo $i; ?>" class="collapse" role="tabpanel" aria-labelledby="faq<?php echo $i; ?>" data-parent="#accordion">
	...
	<section class="testimonial-section">
		<div class="container">
			<div class="row">
				<div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2">
					<div class="sec-heading text-center">
						<h4><?php echo getLabels('TESTIMONIALS1'); ?></h4>
					...
					<div class="client-item-area">
						...
						<div class="client-slider">
							<div class="swiper-wrapper"><?php
								...
								<?php $__currentLoopData = $testimonialsIndex; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $testimonialIndex): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<div class="swiper-slide">
										<div class="client-item">
											<div class="client-thumb">
												<?php echo showImage($testimonialIndex->image, "img-fluid", "","", $testimonialIndex->name, 'testimonials'); ?>

											</div>
											<h5 class="title"><?php echo $testimonialIndex->name; ?></h5>
											<span class="sub-title"><?php echo $testimonialIndex->designation; ?></span>
											<p><?php echo $testimonialIndex->content; ?></p>
										</div>
									</div>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('landingpage/layouts/default', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>