            ...
            <div class="modal-body">
                <form>
                    <div class="form-group ">
                        <label>Name</label>
                        <?php echo Form::text('name',null, array('class' => 'form-control', 'id' => 'scorecardname')); ?>                     
                        <div class="invalid-tooltip"></div>
                    </div>
                    <div class="form-group ">
                        <label>Status</label>
                        <?php echo Form::select('status',config('constants.SCORECARD_STATUS'),null, array('class' => 'form-control', 'id' => 'scorecardstatus')); ?>                     
                        <div class="invalid-tooltip"></div>
                    </div>
                    <div class="form-group">
