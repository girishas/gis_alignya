            ...
            <div class="modal-body">
                <form>
                    <div class="form-group ">
                        <label>Name</label>
                        <?php echo Form::text('theme_name',null, array('class' => 'form-control', 'id' => 'themename')); ?>                     
                        <div class="invalid-tooltip"></div>
                    </div>
                    <div class="form-group ">
                        <label>Summary</label>
                        <?php echo Form::textarea('theme_summary',null, array('rows' => 2,'class' => 'form-control', 'id' => 'themesummary')); ?>                     
                        <div class="invalid-tooltip"></div>
                    </div>
                    <div class="form-group">
