...
<?php $__env->startSection('content'); ?>
 <main>
	<div class="container-fluid">
		<div class="row">
			<div class="col-12">
				<h1><?php echo getLabels('email_template_detail'); ?></h1>
				<div class="text-zero top-right-button-container">
					<a href="<?php echo url($route_prefix, 'templates'); ?>" class="steamerst_link btn btn-primary btn-lg top-right-button mr-1 text-uppercase"><?php echo getLabels('Email_Templates'); ?></a>
				</div>
				<nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
					<ol class="breadcrumb pt-0">
						...
						<li class="breadcrumb-item active" aria-current="page"><?php echo getLabels('email_template_detail'); ?></li>
					</ol>
				</nav>
                ...
                <tbody>
                    <tr>
                        ...
                        <td align="right" valign="center" style="padding-bottom:40px;border-top:0;height:100% !important;width:100% !important;">
                            <span style="color: #8f8f8f; font-weight: normal; line-height: 2; font-size: 14px;"><?php echo date('Y/m/d'); ?></span>
                        </td>
                    </tr>
					<td colspan="2"><h3 class="text-primary" style="font-weight:800;"><?php echo getLabels('english'); ?> : </h3></td>
                    <tr>
                        <td colspan="2" style="padding-top:10px;padding-bottom:10px;border-top:1px solid #e4e2e2">
                            <h3 style="color:#303030; font-size:18px; line-height: 1.6; font-weight:500;"><?php echo $data->subject_en; ?></h3>
							<?php echo $data->content_en; ?>

                        </td>
                    </tr>
					<td colspan="2"><h3 class="text-primary" style="font-weight:800;"><?php echo getLabels('spanish'); ?> : </h3></td>
                    <tr>
                        <td colspan="2" style="padding-top:10px;padding-bottom:10px;border-top:1px solid #e4e2e2">
                            <h3 style="color:#303030; font-size:18px; line-height: 1.6; font-weight:500;"><?php echo $data->subject_sp; ?></h3>
							<?php echo $data->content_sp; ?>

                        </td>
                    </tr>
					
					<td colspan="2"><h3 class="text-primary" style="font-weight:800;"><?php echo getLabels('french'); ?> : </h3></td>
                    <tr>
                        <td colspan="2" style="padding-top:10px;padding-bottom:10px;border-top:1px solid #e4e2e2">
                            <h3 style="color:#303030; font-size:18px; line-height: 1.6; font-weight:500;"><?php echo $data->subject_fr; ?></h3>
							<?php echo $data->content_fr; ?>
                    ...
                    <tr>
                        <td align="center" valign="center">
                            <p style="font-size: 12px; text-decoration: none;line-height: 1; color:#909090; margin-top:0px; ">
								<?php echo config('constants.COPYRIGHT_MESSAGE'); ?>
