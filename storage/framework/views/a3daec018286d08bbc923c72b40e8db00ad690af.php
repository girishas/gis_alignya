    ...
    <div class="row">
    <div class="col-12">
    <h1><?php echo getLabels('KPI'); ?></h1>
    <div class="text-zero top-right-button-container">
    <a href="javascript:void(0);" class=" btn btn-primary btn-sm top-right-button mr-1" id="add_objectiveBtn"><?php echo getLabels('add_kpi'); ?></a>
    <button type="button" class="btn btn-outline-primary mb-1" onclick="filter()">Filters</button>
    </div>
    <?php echo $__env->make('Element/kpi/view_kpi', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <?php echo $__env->make('Element/kpi/update_kpi', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <?php echo $__env->make('frontend/kpi/filter', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <li class="breadcrumb-item active" aria-current="page"><?php echo getLabels('KPI'); ?></li>
    </ol>
    </nav>
                ...
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    $remove_url = url('kpi/remove/'.$value->id); ?>
    					<tr>
    						...
    						<td>
    							<a href="javascript:void(0);" onclick="updateKPI('<?php echo $value->id; ?>')"><i class="simple-icon-pencil heading-icon"></i></a>
                                <a href="javascript:void(0);" onclick="viewMeasure('<?php echo $value->id; ?>')"><i class="iconsminds-information heading-icon"></i></a>
...
<?php echo $__env->make('Element/js/includejs', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    $(document).ready(function(){
        ...
        var kpimessage = "<?php echo session('kpimessage')?session('kpimessage'):''; ?>";
        if(kpimessage != ""){
            showNotificationApp('top', 'right', 'primary', 'success', '<?php echo session("kpimessage"); ?>');
        }
