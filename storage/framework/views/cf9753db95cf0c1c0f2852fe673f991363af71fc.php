    ...
    <div class="table-responsive">
    	<table class="table">
    		<thead class="thead-light">
    			<tr>
    			   <th> <?php echo SortableTrait::link_to_sorting_action('heading',  getLabels('Name')); ?> </th>
    				<th> <?php echo SortableTrait::link_to_sorting_action('measure_cycle_quarter',  getLabels('Cycle')); ?> </th>
                    <th> <?php echo SortableTrait::link_to_sorting_action('team_head',  getLabels('Owner')); ?> </th>
                    <th> <?php echo SortableTrait::link_to_sorting_action('status_name',  getLabels('Status')); ?> </th>
    		...
    		<tbody>
                        ...
                        <tr>
    						<td><a href="javascript:void(0);" id="myBtn"><i class="iconsminds-up-1 heading-icon" style="color:<?php echo $value->bg_color; ?>"></i><?php echo $value->heading; ?></td>
