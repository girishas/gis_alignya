<div class="modal modal-right" id="myModalAddMeasure" role="dialog" >
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control">
                                <option label="&nbsp;">Select Objective</option>
                                <option value="Flexbox">Objective 1</option>
                                <option value="Flexbox">Objective 2</option>
                                <option value="Flexbox">Objective 3</option>
