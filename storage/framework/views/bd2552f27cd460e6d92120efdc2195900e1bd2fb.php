<div class="modal modal-right" id="myModalUpdateMeasure" role="dialog" style="overflow: scroll;">
        <div class="modal-dialog" style="max-width: 99.99%">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Update Measure</h5>
                    <button type="button" class="close" id="popupaddhideUpdateMeasure" aria-label="Close">
                    ...
                    <?php echo Form::open(array('url' => array($route_prefix.'/updatemeasure'), 'class' =>'alignya_form needs-validation tooltip-label-right', 'name'=>'Search', 'files'=>true)); ?>
                       ...
                       <div class="form-group col-md-6">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <?php echo Form::select('contributers[]',$contributers,null,array('class'=>'form-control' ,'id'=>'contributersupdatemeasure','multiple'=>'multiple')); ?>
