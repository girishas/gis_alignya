                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                                <a href="#">
                                                    <img alt="Profile Picture" src="<?php echo url('public/img/profile-pic-l.jpg'); ?>" class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall">
                                                </a>
                                                <div class="pl-3">
                                                    <a href="#">
                                            ...
                                            <div class="d-flex flex-row mb-3 pb-3 border-bottom ">
                                                <a href="#">
                                                    <img alt="Profile Picture" src="<?php echo url('public/img/profile-pic-l-4.jpg'); ?>" class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall">
                                                </a>
                                                <div class="pl-3">
                                                    <a href="#">
