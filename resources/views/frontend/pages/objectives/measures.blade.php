    ...
    <div class="row">
    <div class="col-12">
    <h1>{!! getLabels('Measure') !!}</h1>
    <div class="text-zero top-right-button-container">
    <a href="javascript:void(0);" class=" btn btn-primary btn-lg top-right-button mr-1" id="add_objectiveBtn">{!! getLabels('add_measure') !!}</a>
    </div>
    ...
    <div class="modal modal-right" id="myModal" role="dialog" >
        <div class="modal-dialog" style="max-width: 99.99%;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"> Ticket Prices Differential</h5>
    ...
    <div class="table-responsive">
    	<table class="table">
    		...
    		<tbody>
    					<tr class="odd gradeX">
    						<td><a href="javascript:void(0);" id="myBtn"><i class="fa fa-arrow-up" style="font-size:23px;color:green;"></i>   Ticket Prices Differential</td>
    						<td> FY2020-Q2</td>
                            <td> Jhon</td>
    						<td>
