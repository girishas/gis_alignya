        ...
        <div class="container-fluid">
                    ...
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0">
                            <li class="breadcrumb-item">
                              ...
                              <li class="breadcrumb-item">
                                <a class="steamerst_link" href="{!! url($route_prefix, 'labels') !!}">{!! str_singular(getLabels('Labels')) !!}</a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">{!! getLabels('add_new_label') !!}</li>
                        </ol>
                    </nav>
            ...
            <div class="card mb-4">
				<div class="card-body">
					...
					{!! Form::open(array('url' => array($route_prefix.'/labels/add'), 'class' =>'steamerstudio_form needs-validation tooltip-label-right', 'name'=>'Search')) !!}
