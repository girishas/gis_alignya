        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    ...
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{!! getLabels('update_badge') !!}</li>
                        </ol>
                    </nav>
           ...
           <div class="card mb-4">
				<div class="card-body">
					...
					{!! Form::model($data, array('url' => array($route_prefix.'/badges/edit/'.$data->id), 'class' =>'steamerstudio_form needs-validation tooltip-label-right', 'name'=>'Search', 'files'=>true)) !!}
						<div class="form-row">
							<div class="form-group col-md-3">
								...
								<div class="slim" data-ratio="1:1" data-instant-edit="true" data-will-remove="profileimageWillBeRemoved">
									@if ( $data->image and file_exists('public/upload/badges/'. $data->image) )
										{!! HTML::image('public/upload/badges/'. $data->image, $data->first_name) !!}
									@endif
