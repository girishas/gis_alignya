                                ...
                                <div class="col-lg-4 col-12 mb-4">
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            {!!ideacommentscount($idea_details->id)!!} &nbsp; <i class="simple-icon-like"></i> {!!idealikescount($idea_details->id)!!}
                                        </p>
                                        </div>
                                    </div>
                                            ...
                                            <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                                ...
                                                <div class="pl-3">
                                                    ...
                                                    <p class="text-muted text-small mb-2">
                                                        ...
                                                        {!!ideacommentscount($idea_details->id)!!} &nbsp; <i class="simple-icon-dislike"></i> {!!idealikescount($idea_details->id)!!}
                                                    </p>
                                                    </a>
                                                </div>
                                            </div>
