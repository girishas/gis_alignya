    ...
    <div class="row justify-content-center mt-0">
        <div class="col-11 col-sm-9 col-md-7 col-lg-12 text-center p-0 mt-3 mb-2">
			...
			<p class="h2">Create Your Account</p> 
                <p class="mb-2">One account is all you need to manage your business strategy. Let's get Started !
                            </p>
                <div class="row">
                    <div class="col-md-12 mx-0">
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <div class="row" >
                                        ...
                                        <div class="first_name_error" style="padding-bottom:10px;color: red"></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="email_error" style="padding-bottom:10px;color: red"></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="password_error" style="padding-bottom:10px;color: red"></div>
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <div class="col-md-12">
                                        <div class="company_name_error" style="padding-bottom:10px;color: red"></div>
                            ...
                            <fieldset>
                                 <div class="row equal-height-container" style="margin:0 20px;">

                        <div class="col-12 mb-4 fs-title ml-2">Choose Your Pricing Plan </div>
