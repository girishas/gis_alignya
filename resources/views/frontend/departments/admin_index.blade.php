...
@section('content')
  <main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1>{!! getLabels('Departments') !!}</h1>
					<div class="text-zero top-right-button-container">
						<a href="{!! url($route_prefix.'/department/new') !!}" class="steamerst_link btn btn-primary btn-lg top-right-button mr-1">{!! getLabels('add_new') !!}</a>
                    </div>
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{!! getLabels('Departments') !!}</li>
                        </ol>
                    </nav>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            {!! Form::open(array('url' => array($route_prefix.'/departments'), 'class' =>'steamerstudio_searchform', 'name'=>'Search')) !!}
								<div class="form-body">
									<div class="row">
										<div class="col-lg-3">
							...
							<div class="table-responsive">
								<table class="table">
									<thead class="thead-light">
										<tr>
										   <th> {!! SortableTrait::link_to_sorting_action('department_name',  getLabels('Department Name')) !!} </th>
											<th> {!! SortableTrait::link_to_sorting_action('parent_department_id',  getLabels('Department Head')) !!} </th>
											...
											@foreach($data as $val)
												<tr class="odd gradeX">
													<td>
														...
														<?php }?>
														{!!$str!!}
														{!! $val->department_name!!}</td>
													<td>{!! $val->department_head_name !!}</td>
													<td>
														<div class="btn-group float-none-xs">
															...
															<div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 25px, 0px);">
																<a class="steamerst_link dropdown-item" href="{!! url($route_prefix.'/department/update/'.$val->id) !!}">{!! getLabels('edit') !!}</a>
