...
@section('content')
  <main>
                ...
                <div class="col-12">
                    ...
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{!! getLabels('scorecards') !!}</li>
                        </ol>
                    </nav>
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            {!! Form::open(array('url' => array($route_prefix.'/scorecards'), 'class' =>'steamerstudio_searchform', 'name'=>'Search')) !!}
								<div class="form-body">
									<div class="row">
										<div class="col-lg-3">
										...
										<div class="col-lg-3">               
											...
											<a class="btn btn-dark mb-1 steamerst_link" href="{!! url($route_prefix, 'scorecards') !!}">{!! getLabels('show_all') !!}</a>
										</div>
									</div>
								</div>
							{!!Form::close()!!}
							...
							<div class="table-responsive">
								<table class="table">
									<thead class="thead-light">
										<tr>
										   <th> {!! getLabels('scorecard_name') !!} </th>
    ...
    @include('Element/department/addscorecard')
    @include('Element/department/updatescorecard')
