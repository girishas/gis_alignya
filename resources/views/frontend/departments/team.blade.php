                ...
                <div class="col-12">
                    <h1> <span class="align-middle d-inline-block pt-1">Department Insights</span>   
                        ...
                        <div class="float-md-right">
							<button type="button" class="btn btn-outline-primary mb-1">Add New</button>
							...
							<button type="button" class="btn btn-primary mb-1">Members</button>
							<button type="button" class="btn btn-primary mb-1">Teams</button>
                                        ...
                                        <div class="card-body">
                                            <p class="list-item-heading mb-4">Finance</p> 
                                               ...
                                               <div
                                                ...
                                                <a href="#">
                                                    <img src="img/profile-pic-l-2.jpg" alt="Philip Nelms"
                ...
                <div class="card mb-4 col-lg-4 col-4">
                                        <div class="card-body">
                                            ...
                                            <div
                                                class="d-flex flex-row mb-3 pb-3 border-bottom justify-content-between align-items-center">
                                                <a href="#">
                                                    <img src="img/profile-pic-l-4.jpg" alt="Mimi Carreira"
                                                        class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                                                </a>
                                                <div class="pl-3 flex-fill">
                                                    <a href="#">
                                            ...
                                            <div
                                                class="d-flex flex-row mb-3 pb-3 border-bottom justify-content-between align-items-center">
                                                <a href="#">
                                                    <img src="img/profile-pic-l-3.jpg" alt="Brynn Bragg"
                                                        class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                                                </a>
                                                <div class="pl-3 flex-fill">
                                                    <a href="#">
                                            ...
                                            <div
                                                class="d-flex flex-row mb-3 pb-3 border-bottom justify-content-between align-items-center">
                                                <a href="#">
                                                    <img src="img/profile-pic-l-7.jpg" alt="Rasheeda Vaquera"
                                                        class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                                                </a>
                                                <div class="pl-3 flex-fill">
                                                    <a href="#">
                                            ...
                                            <div
                                                class="d-flex flex-row mb-3 pb-3 border-bottom justify-content-between align-items-center">
                                                <a href="#">
                                                    <img src="img/profile-pic-l-8.jpg" alt="Mayra Sibley"
                                                        class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                                                </a>
                                                <div class="pl-3 flex-fill">
                                                    <a href="#">
