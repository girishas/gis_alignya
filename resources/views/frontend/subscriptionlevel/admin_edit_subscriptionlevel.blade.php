...
@section('content')
  <main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1>{!! getLabels('update_subscription_level') !!}</h1>
                    ...
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{!! getLabels('update_subscription_level') !!}</li>
                        </ol>
                    </nav>
           ...
           <div class="card mb-4">
				<div class="card-body">
					...
					{!! Form::model($data, array('url' => array($route_prefix.'/subscriptionlevel/edit/'.$data->id), 'class' =>'steamerstudio_form needs-validation tooltip-label-right', 'name'=>'Search', 'files'=>true)) !!}
