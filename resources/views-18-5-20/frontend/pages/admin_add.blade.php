        ...
        <div class="container-fluid">
                ...
                <div class="col-12">
                    ...
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{!! getLabels('add_new_page') !!}</li>
                        </ol>
                    </nav>
           ...
           <div class="card mb-4">
				<div class="card-body">
					...
					{!! Form::open(array('url' => array($route_prefix.'/add-new-page'), 'class' =>'steamerstudio_form needs-validation tooltip-label-right', 'name'=>'Search')) !!}
						<div class="form-group  position-relative error-l-50">
							<label for="inputTitle">{!! getLabels('Title') !!} ({!! getLabels('english') !!})</label>
