...
@section('content')
  ...
  @endif
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1>{!! getLabels('add_email_template') !!}</h1>
                    ...
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{!! getLabels('add_email_template') !!}</li>
                        </ol>
                    </nav>
           ...
           <div class="card mb-4">
				<div class="card-body">
					...
					{!! Form::open(array('url' => array($route_prefix.'/templates/add'), 'class' =>'steamerstudio_form needs-validation tooltip-label-right', 'name'=>'Search')) !!}
						...
						<div class="form-group  position-relative error-l-60">
							<label for="inputMetaTitle">{!! getLabels('subject') !!} ({!! getLabels('english') !!})</label>
						...
						<div class="form-group  position-relative error-l-50">
							<label for="inputContent">{!! getLabels('Content') !!} ({!! getLabels('english') !!})</label>
