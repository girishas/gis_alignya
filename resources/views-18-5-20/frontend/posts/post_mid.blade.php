													...
													<div class="d-flex flex-grow-1 min-width-zero">
														<div class="card-body">
															<div class="min-width-zero">
																...
																<div class="">
																	<a href="{!! url($route_prefix.'/'.$post->postUser->uniq_username.'/profile') !!}" class="steamerst_link btn btn-xs btn-outline-primary mr-2">{!! getLabels('profile') !!}</a>
																	<?php /* @if(Auth::id() != $post->postUser->id)
																		<a href="{!! url($route_prefix.'/'.$post->postUser->uniq_username.'/profile') !!}" class="steamerst_link btn btn-xs btn-outline-primary">Follow</a>
																	@endif */ ?>
																</div>
															</div>
														</div>
