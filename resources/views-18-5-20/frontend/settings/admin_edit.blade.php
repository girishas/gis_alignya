...
@section('content')
  ...
  <main>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <h1>{!! getLabels('update_language') !!}</h1>
                    ...
                    <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                        <ol class="breadcrumb pt-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{!! getLabels('update_language') !!}</li>
                        </ol>
                    </nav>
           ...
           <div class="card mb-4">
				<div class="card-body">
					...
					{!! Form::model($data, array('url' => array($route_prefix.'/languages/edit/'.$data->id), 'class' =>'steamerstudio_form needs-validation tooltip-label-right', 'name'=>'Search', 'files'=>true)) !!}
						<div class="form-row">
							<div class="form-group col-md-3">
								...
								<div class="slim" data-ratio="3:2" data-instant-edit="true" data-will-remove="profileimageWillBeRemoved">
									@if ( $data->icon and file_exists('public/upload/language/'. $data->icon) )
										{!! HTML::image('public/upload/language/'. $data->icon, $data->first_name) !!}
									@endif
						...
						<div class="form-group  position-relative error-l-100">
							...
							{!! Form::select('status', array('' => 'Please Select','0' => 'inactive', '1' => 'active'),null, array('class' =>'form-control'))!!}
							<div class="invalid-tooltip"></div>
						</div>
