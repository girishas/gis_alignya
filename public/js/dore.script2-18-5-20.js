...
var nextClasses = "menu-sub-hidden";
// State Button
(function ($) {
  ...
  function init() {
    ...
    if ($().fullCalendar) {
      ...
      $(".calendar").fullCalendar({
		...
		{ 
			newhtml = '<a href="javascript:void(0);"><div class="font-weight-medium mb-0 "><div class="tooltipc">Krishan<div class="tooltiptext"></div></div></div></a>';
