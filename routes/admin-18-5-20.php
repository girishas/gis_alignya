...
Route::any('subscriptions-admin', array('as'=>'subscriptions.admin_subscriptions', 'uses'=>'SubscriptionController@admin_subscriptions'));
...
Route::any('payouts', array('as'=>'subscriptions.admin_payouts', 'uses'=>'SubscriptionController@admin_payouts'));
Route::any('/payout-history', array('as'=>'subscriptions.payout_history', 'uses' => 'SubscriptionController@payout_history'));
Route::any('/payout-amount-detail/{slug?}', array('as'=>'subscriptions.payouts_amount_details', 'uses' => 'SubscriptionController@payouts_amount_details'));
Route::any('/payouttoowner/{slug?}', array('as'=>'subscriptions.payouttoowner', 'uses' => 'SubscriptionController@payouttoowner'));
Route::any('/payout-history-detail/{id?}', array('as'=>'subscriptions.payout_history_detail', 'uses' => 'SubscriptionController@payout_history_detail'));
Route::any('/transaction-manager', array('as'=>'subscriptions.transaction_manager', 'uses' => 'SubscriptionController@transaction_manager'));
